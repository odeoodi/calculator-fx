...
public class ResultService {
    ...
    private static final String DB_USER = "heikki";
    private static final String DB_PASSWORD = "pekka";
    ...
    public static void saveResult(double n1, double n2, double sum, double product, double subtract, double division) {
        ...
        try (Connection conn = DriverManager.getConnection(dbUrl, DB_USER, DB_PASSWORD);
            ...
            System.out.println("✅ Result saved: " + n1 + ", " + n2 + " → Sum=" + sum + ", Product=" + product + ", Substract=" + subtract +  ", Division=" + division);
